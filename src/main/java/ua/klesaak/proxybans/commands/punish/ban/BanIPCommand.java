...
public final class BanIPCommand extends AbstractPunishCommand {

    public BanIPCommand(ProxyBansManager proxyBansManager) {
        super(proxyBansManager, PunishType.IP_BAN);
    }
    ...
    public boolean onReceiveCommand(CommandSender sender, String[] args) {
        ...
        messagesFile.getBroadcastIpBanned()
        ...
        this.disconnect(nickName, messagesFile.getMessageBannedIp()
                .tag(PUNISHER_NAME_PATTERN, punisherName)
