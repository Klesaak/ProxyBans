...
public final class OpTempMuteCommand extends AbstractPunishCommand {

    public OpTempMuteCommand(ProxyBansManager proxyBansManager) {
        super(proxyBansManager, PunishType.OP_TEMP_MUTE);
    }
    ...
    public boolean onReceiveCommand(CommandSender sender, String[] args) throws AbstractCommandException {
        ...
        this.cmdVerifyArgs(4, args, messagesFile.getUsageOpTempMuteCommand());
        ...
        messagesFile.getMessageOpTempMuted()
                .tag(PUNISHER_NAME_PATTERN, punisherName)
