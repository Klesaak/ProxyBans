...
public final class TempBanCommand extends AbstractPunishCommand {
    ...
    public TempBanCommand(ProxyBansManager proxyBansManager) {
        super(proxyBansManager, PunishType.TEMP_BAN);
    }
    ...
    public boolean onReceiveCommand(CommandSender sender, String[] args) throws AbstractCommandException {
        ...
        this.cmdVerifyArgs(4, args, messagesFile.getUsageTempBanCommand());
        ...
        this.disconnect(nickName, messagesFile.getMessageTempBanned()
                .tag(PUNISHER_NAME_PATTERN, punisherName)
