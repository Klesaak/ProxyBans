...
public final class OpMuteCommand extends AbstractPunishCommand {

    public OpMuteCommand(ProxyBansManager proxyBansManager) {
        super(proxyBansManager, PunishType.OP_MUTE);
    }
    ...
    public boolean onReceiveCommand(CommandSender sender, String[] args) throws AbstractCommandException {
        ...
        this.cmdVerifyArgs(3, args, messagesFile.getUsageOpMuteCommand());
        ...
        messagesFile.getBroadcastOpMuted()
        ...
        messagesFile.getMessageOpMuted()
                .tag(PUNISHER_NAME_PATTERN, punisherName)
