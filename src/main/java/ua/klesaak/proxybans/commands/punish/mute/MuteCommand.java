...
public final class MuteCommand extends AbstractPunishCommand {
    ...
    public MuteCommand(ProxyBansManager proxyBansManager) {
        super(proxyBansManager, PunishType.MUTE);
    }
    ...
    public boolean onReceiveCommand(CommandSender sender, String[] args) throws AbstractCommandException {
        ...
        this.cmdVerifyArgs(3, args, messagesFile.getUsageMuteCommand());
        ...
        messagesFile.getBroadcastMuted()
